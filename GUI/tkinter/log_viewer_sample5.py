...
class LogViewer(tkinter.Frame):
    ...
    def __init__(self, root: tkinter.Tk):
        ...
        self.page_count = tkinter.IntVar(value=0)
    ...
    def create_widgets(self):
        ...
        self.page_count_label = tkinter.Label(
            self.page_count_label_frame, textvariable=self.page_count, width=6, font=font1)
        ...
        self.first_page_label_frame = tkinter.Button(
            self.page_selecter_label_frame, text='<<', width=2, state='disabled', command='')
        self.first_page_label_frame.grid(row=0, column=0)
        self.previous_page_label_frame = tkinter.Button(
            self.page_selecter_label_frame, text='<', width=2, command='', state='disabled')
        self.previous_page_label_frame.grid(row=0, column=1)
        self.current_page_label_frame = tkinter.Button(self.page_selecter_label_frame, text=str(
            self.current_page.get()), width=2, state='disabled', command='')
        self.current_page_label_frame.grid(row=0, column=2)
        self.next_page_label_frame = tkinter.Button(
            self.page_selecter_label_frame, text='>', width=2, state='disabled', command='')
        self.next_page_label_frame.grid(row=0, column=3)
        self.end_page_label_frame = tkinter.Button(
            self.page_selecter_label_frame, text='>>', width=2, state='disabled', command='')
        self.end_page_label_frame.grid(row=0, column=4)
    ...
    def log_list_view(self):
        ...
        try:
            ...
            if self.record_count:
                records: Cursor = self.log_list_get(self.page_count.get(), self.record_count.get())

                #次ページ、最後のページを活性化
                self.next_page_label_frame['state'] = 'normal'
                self.end_page_label_frame['state'] = 'normal'
                ...
                logs_frame.grid(row=4, column=0, columnspan=4,
                                sticky=tkinter.W)
                ...
                logs_table.append([
                    ...
                    tkinter.Label(logs_frame, text='record_type',
                                  relief='groove'),
